...
@section('content')
    ...
    <section class="table-container">
        <div class="table-section-header">
            <h3>Links do canal {{ $channel->name }}</h3>
            <a href="{{ route('channels.links.create', ['channel' => $channel->id]) }}" class="btn btn-primary btn-sm">
            ...
            <tbody>
                @forelse ($links as $link)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('channels.links.edit', [
                        'channel' => $link->tv_channel_id,
                        'link' => $link->id
                                    ...
                                    <form action="{{ route('channels.links.destroy', [$channel, $link->id]) }}" method="POST"
